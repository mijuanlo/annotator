...
gchar* vala_get_ccode_type_name (ValaObjectTypeSymbol* sym);
gchar* vala_get_ccode_type_cast_function (ValaObjectTypeSymbol* sym);
gchar* vala_get_ccode_type_get_function (ValaObjectTypeSymbol* sym);
gchar* vala_get_ccode_class_get_private_function (ValaClass* cl);
gchar* vala_get_ccode_class_type_function (ValaClass* cl);
...
gboolean vala_is_ref_function_void (ValaDataType* type);
gboolean vala_is_free_function_address_of (ValaDataType* type);
...
gboolean vala_get_ccode_finish_instance (ValaMethod* m);
gchar* vala_get_ccode_type_id (ValaCodeNode* node);
gchar* vala_get_ccode_type_function (ValaTypeSymbol* sym);
...
gchar* vala_get_ccode_class_type_check_function (ValaClass* cl);
...
gdouble vala_get_ccode_error_pos (ValaCallable* c);
...
gchar* vala_get_ccode_delegate_target_destroy_notify_name (ValaVariable* variable);
...
gdouble vala_get_ccode_async_result_pos (ValaMethod* m);
...
gboolean vala_get_ccode_has_emitter (ValaSignal* sig);
...
gboolean vala_get_ccode_no_wrapper (ValaMethod* m);
...
const gchar* vala_ccode_attribute_get_delegate_target_destroy_notify_name (ValaCCodeAttribute* self);
...
gint vala_ccode_base_module_get_current_try_id (ValaCCodeBaseModule* self);
void vala_ccode_base_module_set_current_try_id (ValaCCodeBaseModule* self,
                                                gint value);
gint vala_ccode_base_module_get_next_try_id (ValaCCodeBaseModule* self);
void vala_ccode_base_module_set_next_try_id (ValaCCodeBaseModule* self,
                                             gint value);
...
gint vala_ccode_base_module_get_current_inner_error_id (ValaCCodeBaseModule* self);
void vala_ccode_base_module_set_current_inner_error_id (ValaCCodeBaseModule* self,
                                                        gint value);
gboolean vala_ccode_base_module_get_is_in_method_precondition (ValaCCodeBaseModule* self);
void vala_ccode_base_module_set_is_in_method_precondition (ValaCCodeBaseModule* self,
                                                           gboolean value);
...
extern ValaSet* vala_ccode_base_module_reserved_identifiers;
...
void vala_ccode_base_module_append_params_array (ValaCCodeBaseModule* self,
                                                 ValaMethod* m);
...
void vala_ccode_base_module_generate_constant_declaration (ValaCCodeBaseModule* self,
                                                           ...
                                                           ValaCCodeFile* decl_space,
                                                           gboolean definition);
void vala_ccode_base_module_append_field (ValaCCodeBaseModule* self,
...
void vala_ccode_base_module_generate_field_declaration (ValaCCodeBaseModule* self,
                                                        ValaField* f,
                                                        ValaCCodeFile* decl_space);
gboolean vala_ccode_base_module_is_constant_ccode_expression (ValaCCodeExpression* cexpr);
gboolean vala_ccode_base_module_is_constant_ccode (ValaCodeNode* expr);
gboolean vala_ccode_base_module_is_pure_ccode_expression (ValaCCodeExpression* cexpr);
...
gboolean vala_ccode_base_module_no_implicit_copy (ValaCCodeBaseModule* self,
                                                  ValaDataType* type);
ValaCCodeExpression* vala_ccode_base_module_get_cexpression (ValaCCodeBaseModule* self,
                                                             const gchar* name);
ValaCCodeExpression* vala_ccode_base_module_get_local_cexpression (ValaCCodeBaseModule* self,
                                                                   ValaLocalVariable* local);
ValaCCodeExpression* vala_ccode_base_module_get_parameter_cexpression (ValaCCodeBaseModule* self,
                                                                       ValaParameter* param);
...
ValaCCodeExpression* vala_ccode_base_module_get_this_interface_cexpression (ValaCCodeBaseModule* self,
                                                                            ValaInterface* iface);
ValaCCodeExpression* vala_ccode_base_module_get_inner_error_cexpression (ValaCCodeBaseModule* self);
...
gchar* vala_ccode_base_module_generate_free_function_address_of_wrapper (ValaCCodeBaseModule* self,
                                                                         ValaDataType* type);
gchar* vala_ccode_base_module_generate_destroy_function_content_of_wrapper (ValaCCodeBaseModule* self,
                                                                            ValaDataType* type);
...
ValaCCodeExpression* vala_ccode_base_module_get_destroy_func_expression (ValaCCodeBaseModule* self,
                                                                         ValaDataType* type,
                                                                         gboolean is_chainup);
gchar* vala_ccode_base_module_append_struct_array_destroy (ValaCCodeBaseModule* self,
                                                           ValaStruct* st);
...
void vala_ccode_base_module_append_local_free (ValaCCodeBaseModule* self,
                                               ...
                                               ValaCodeNode* stop_at);
void vala_ccode_base_module_append_out_param_free (ValaCCodeBaseModule* self,
                                                   ValaMethod* m);
...
gchar* vala_ccode_base_module_get_delegate_target_destroy_notify_cname (ValaCCodeBaseModule* self,
                                                                        const gchar* delegate_cname);
gboolean vala_ccode_base_module_requires_copy (ValaDataType* type);
gboolean vala_ccode_base_module_requires_destroy (ValaDataType* type);
...
void vala_ccode_base_module_generate_interface_declaration (ValaCCodeBaseModule* self,
                                                            ValaInterface* iface,
                                                            ValaCCodeFile* decl_space);
gboolean vala_ccode_base_module_generate_method_declaration (ValaCCodeBaseModule* self,
                                                             ValaMethod* m,
                                                             ValaCCodeFile* decl_space);
...
ValaCCodeExpression* vala_ccode_base_module_serialize_expression (ValaCCodeBaseModule* self,
                                                                  ValaDataType* type,
                                                                  ValaCCodeExpression* expr);
ValaCCodeExpression* vala_ccode_base_module_create_type_check (ValaCCodeBaseModule* self,
...
ValaDataType* vala_ccode_base_module_get_callable_creturn_type (ValaCallable* c);
...
gboolean vala_ccode_base_module_is_lvalue_access_allowed (ValaCCodeBaseModule* self,
                                                          ValaDataType* type);
gboolean vala_ccode_base_module_requires_memset_init (ValaCCodeBaseModule* self,
                                                      ValaVariable* variable,
...
ValaCCodeExpression* vala_ccode_base_module_get_value_getter_function (ValaCCodeBaseModule* self,
                                                                       ValaDataType* type_reference);
ValaCCodeExpression* vala_ccode_base_module_get_value_setter_function (ValaCCodeBaseModule* self,
                                                                       ValaDataType* type_reference);
ValaCCodeExpression* vala_ccode_base_module_get_value_taker_function (ValaCCodeBaseModule* self,
                                                                      ValaDataType* type_reference);
...
gchar* vala_ccode_base_module_get_array_length_cname (ValaCCodeBaseModule* self,
                                                      ...
                                                      gint dim);
gchar* vala_ccode_base_module_get_variable_array_length_cname (ValaCCodeBaseModule* self,
                                                               ValaVariable* variable,
                                                               gint dim);
...
gchar* vala_ccode_base_module_generate_ready_function (ValaCCodeBaseModule* self,
                                                       ValaMethod* m);
ValaCCodeExpression* vala_ccode_base_module_get_boolean_cconstant (ValaCCodeBaseModule* self,
                                                                   gboolean b);
...
void vala_gasync_module_append_struct (ValaGAsyncModule* self,
...
GType vala_gvalue_module_get_type (void) G_GNUC_CONST;
...
ValaGLibValue* vala_glib_value_new (ValaDataType* value_type,
                                    ValaCCodeExpression* cvalue,
                                    gboolean lvalue);
ValaGLibValue* vala_glib_value_construct (GType object_type,
                                          ValaDataType* value_type,
                                          ValaCCodeExpression* cvalue,
                                          gboolean lvalue);
void vala_glib_value_append_array_length_cvalue (ValaGLibValue* self,
                                                 ValaCCodeExpression* length_cvalue);
ValaGLibValue* vala_glib_value_copy (ValaGLibValue* self);
ValaCCodeExpression* vala_get_cvalue (ValaExpression* expr);
ValaCCodeExpression* vala_get_cvalue_ (ValaTargetValue* value);
void vala_set_cvalue (ValaExpression* expr,
                      ValaCCodeExpression* cvalue);
ValaCCodeExpression* vala_get_array_size_cvalue (ValaTargetValue* value);
void vala_set_array_size_cvalue (ValaTargetValue* value,
                                 ValaCCodeExpression* cvalue);
ValaCCodeExpression* vala_get_delegate_target (ValaExpression* expr);
void vala_set_delegate_target (ValaExpression* expr,
                               ValaCCodeExpression* delegate_target);
ValaCCodeExpression* vala_get_delegate_target_destroy_notify (ValaExpression* expr);
void vala_set_delegate_target_destroy_notify (ValaExpression* expr,
                                              ValaCCodeExpression* destroy_notify);
void vala_append_array_length (ValaExpression* expr,
                               ValaCCodeExpression* size);
ValaList* vala_get_array_lengths (ValaExpression* expr);
gboolean vala_get_lvalue (ValaTargetValue* value);
gboolean vala_get_non_null (ValaTargetValue* value);
const gchar* vala_get_ctype (ValaTargetValue* value);
gboolean vala_get_array_null_terminated (ValaTargetValue* value);
ValaCCodeExpression* vala_get_array_length_cexpr (ValaTargetValue* value);
...
ValaGValueModule* vala_gvalue_module_new (void);
ValaGValueModule* vala_gvalue_module_construct (GType object_type);
