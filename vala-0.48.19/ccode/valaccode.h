...
GType vala_ccode_define_get_type (void) G_GNUC_CONST;
G_DEFINE_AUTOPTR_CLEANUP_FUNC (ValaCCodeDefine, vala_ccode_node_unref)
const gchar* vala_ccode_define_get_name (ValaCCodeDefine* self);
void vala_ccode_define_set_name (ValaCCodeDefine* self,
                                 const gchar* value);
const gchar* vala_ccode_define_get_value (ValaCCodeDefine* self);
void vala_ccode_define_set_value (ValaCCodeDefine* self,
                                  const gchar* value);
ValaCCodeExpression* vala_ccode_define_get_value_expression (ValaCCodeDefine* self);
void vala_ccode_define_set_value_expression (ValaCCodeDefine* self,
                                             ValaCCodeExpression* value);
ValaCCodeDefine* vala_ccode_define_new (const gchar* name,
                                        const gchar* value);
ValaCCodeDefine* vala_ccode_define_construct (GType object_type,
                                              const gchar* name,
                                              const gchar* value);
ValaCCodeDefine* vala_ccode_define_new_with_expression (const gchar* name,
                                                        ValaCCodeExpression* expression);
ValaCCodeDefine* vala_ccode_define_construct_with_expression (GType object_type,
                                                              const gchar* name,
                                                              ValaCCodeExpression* expression);
...
void vala_ccode_file_set_is_header (ValaCCodeFile* self,
                                    gboolean value);
ValaSourceFile* vala_ccode_file_get_file (ValaCCodeFile* self);
ValaCCodeFile* vala_ccode_file_new (ValaSourceFile* source_file);
...
ValaCCodeDeclaratorSuffix* vala_ccode_declarator_suffix_new_with_multi_array (ValaList* array_length);
ValaCCodeDeclaratorSuffix* vala_ccode_declarator_suffix_construct_with_multi_array (GType object_type,
...
void vala_ccode_element_access_set_container (ValaCCodeElementAccess* self,
                                              ValaCCodeExpression* value);
ValaList* vala_ccode_element_access_get_indices (ValaCCodeElementAccess* self);
void vala_ccode_element_access_set_indices (ValaCCodeElementAccess* self,
                                            ValaList* value);
...
ValaCCodeElementAccess* vala_ccode_element_access_construct (GType object_type,
                                                             ...
                                                             ValaCCodeExpression* i);
ValaCCodeElementAccess* vala_ccode_element_access_new_with_indices (ValaCCodeExpression* cont,
                                                                    ValaList* i);
ValaCCodeElementAccess* vala_ccode_element_access_construct_with_indices (GType object_type,
                                                                          ValaCCodeExpression* cont,
                                                                          ValaList* i);
