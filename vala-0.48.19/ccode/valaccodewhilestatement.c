...
static GType vala_ccode_while_statement_get_type_once (void);
 ...
 */
static GType
vala_ccode_while_statement_get_type_once (void)
{
...
vala_ccode_while_statement_get_type (void)
{
	...
	if (g_once_init_enter (&vala_ccode_while_statement_type_id__volatile)) {
		GType vala_ccode_while_statement_type_id;
		vala_ccode_while_statement_type_id = vala_ccode_while_statement_get_type_once ();
