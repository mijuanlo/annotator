...
static GType valadoc_content_content_element_get_type_once (void);
...
valadoc_content_content_element_set_parent (ValadocContentContentElement* self,
                                            ValadocContentContentElement* value)
{
	ValadocContentContentElement* old_value;
	g_return_if_fail (self != NULL);
	old_value = valadoc_content_content_element_get_parent (self);
	if (old_value != value) {
		ValadocContentContentElement* _tmp0_;
...
static GType
valadoc_content_content_element_get_type_once (void)
{
	...
	return valadoc_content_content_element_type_id;
}
...
valadoc_content_content_element_get_type (void)
{
	...
	if (g_once_init_enter (&valadoc_content_content_element_type_id__volatile)) {
		GType valadoc_content_content_element_type_id;
		valadoc_content_content_element_type_id = valadoc_content_content_element_get_type_once ();
