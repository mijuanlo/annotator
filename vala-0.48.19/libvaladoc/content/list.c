...
static GType valadoc_content_list_get_type_once (void);
                                ...
                                ValadocContentContentElement* new_parent)
{
	...
	valadoc_content_list_set_bullet (_tmp2_, _tmp3_);
	{
		...
		while (TRUE) {
			...
			_tmp12_ = _item_list;
			_tmp13_ = vala_list_get (_tmp12_, _item_index);
			...
			copy = _tmp17_;
			_tmp18_ = list;
			_tmp19_ = valadoc_content_list_get_items (_tmp18_);
			_tmp20_ = _tmp19_;
			_tmp21_ = copy;
...
static GType
valadoc_content_list_get_type_once (void)
{
