                                    ...
                                    ValadocApiMethod* m)
{
	...
	if (_tmp166_) {
		...
		_tmp188_ = (_tmp187_ != NULL) ? _vala_array_dup10 (_tmp187_, _tmp187__length1) : _tmp187_;
		...
		_tmp192_ = (_tmp191_ != NULL) ? _vala_array_dup11 (_tmp191_, _tmp191__length1) : _tmp191_;
	...
	if (_tmp296_) {
		...
		_tmp329_ = (_tmp328_ != NULL) ? _vala_array_dup12 (_tmp328_, _tmp328__length1) : _tmp328_;
		...
		_tmp333_ = (_tmp332_ != NULL) ? _vala_array_dup13 (_tmp332_, _tmp332__length1) : _tmp332_;
